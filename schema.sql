-- STACKFIT DB 스키마 (SQLite)
-- 역할(role)은 users.role = 'freelancer' | 'company' 로 구분하고,
-- 역할별 부가정보는 freelancer_profiles / companies 테이블에 1:1로 분리했습니다.
...
CREATE TABLE IF NOT EXISTS freelancer_profiles (
  ...
  stack_json  TEXT NOT NULL DEFAULT '[]',   -- JSON array of strings
...
CREATE TABLE IF NOT EXISTS projects (
  ...
  stage         INTEGER NOT NULL DEFAULT 1, -- 1:계약체결 2:계약금정산 3:진행중 4:최종정산
  created_at    TEXT NOT NULL DEFAULT (datetime('now'))
);
